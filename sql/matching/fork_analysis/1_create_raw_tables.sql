...
COMMENT ON TABLE :inputs IS :q_curr: Inputs (from csv file) exported by transaction-exporter'; --'
COMMENT ON TABLE :outputs IS :q_curr: Outputs (from csv file) exported by transaction-exporter'; --'